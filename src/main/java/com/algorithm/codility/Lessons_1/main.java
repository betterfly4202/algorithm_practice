package com.algorithm.codility.Lessons_1;
...
/*
    ...
    class Solution_Lambda { public int solution(int N); }
...
public class main {
    public static void main(String [] args){
        ...
        int binGap = 0;
        int tempCnt = 0;
        for (int bin :decimalArr) {
            if(bin == 1){
                binGap = binGap < tempCnt ? tempCnt : binGap;
                tempCnt = 0 ;
            }else{
                tempCnt++;
            }
        ...
        System.out.println("bin gap :: " + binGap);
